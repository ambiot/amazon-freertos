...
set tooldir=%2\..\..\..\..\..\vendors\realtek\sdk\amebaZ2\component\soc\realtek\8710c\misc\iar_utility
set libdir=%2\..\..\..\..\..\vendors\realtek\sdk\amebaZ2\component\soc\realtek\8710c\misc\bsp
set cfgdir=%3
set iartooldir=%4
