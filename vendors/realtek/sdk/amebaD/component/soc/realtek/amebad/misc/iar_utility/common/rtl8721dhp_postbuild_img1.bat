...
set tooldir=%2\..\..\..\..\..\vendors\realtek\sdk\amebaD\component\soc\realtek\amebad\misc\iar_utility\common\tools
set libdir=%2\..\..\..\..\..\vendors\realtek\sdk\amebaD\component\soc\realtek\amebad\misc\bsp
set iartooldir=%3
